...
public partial class FigurePage : ContentPage
{
    ...
    public FigurePage()
    {
        ...
        tapGesture.Tapped += Klik_boksi_panel;
        ...
        hsl = new HorizontalStackLayout
        {
            ...
            HorizontalOptions = LayoutOptions.Center,
            VerticalOptions = LayoutOptions.Center,
            // можно настраивать цвет, размер вещи
        };
        Content = hsl;
    }

    private void Klik_boksi_panel(object? sender, TappedEventArgs e)
    {
        ...
        boxView.CornerRadius = random.Next(0, 10);
    }
}